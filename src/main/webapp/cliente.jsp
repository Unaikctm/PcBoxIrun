            					...
            					<div class="modal-header bg-success text-white">
           						...
           						<form action="Store_cliente" method="POST">
	                				<div class="modal-body">
	                    				...
	                    				<div class="mb-3">
								            <label for="dni" class="form-label"><b>DNI:</label>
        ...
        <tbody class="table-group-divider">
        	<c:forEach items="${clientes}" var="cliente">
	          <tr>
	            ...
	            <td>
	            	<a href="Show?dni=${cliente.dni}" class="btn btn-primary" title="Visualizar Cliente">
					...
					<button type="button" class="btn btn-warning" title="Editar Cliente" data-bs-toggle="modal" data-bs-target="#${cliente.dni }">
					...
					<!-- Modal -->
					<div class="modal fade" id="${cliente.dni }" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  				...
	  				<a href="Destroy_cliente?dni=${cliente.dni}" class="btn btn-danger" title="Eliminar">

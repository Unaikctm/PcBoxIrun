...
<body style="background: rgb(209,214,214); background: linear-gradient(0deg, rgba(209,214,214,1) 7%, rgba(255,255,255,1) 49%);">
    ...
    <div class="col-sm p-3 min-vh-100">
            					...
            					<div class="modal-header bg-success text-white">
           						...
           						<form action="Store_pedido" method="POST">
	                				<div class="modal-body">
	                    				...
	                    				<div class="mb-3">
								            <label for="dni" class="form-label"><b>DNI del cliente:</label>
								            <input type="text" class="form-control" id="dni" name="dni" value="${pedido.cliente.dni}">
								        </div>
        ...
        <tbody class="table-group-divider">
        	<c:forEach items="${pedidos}" var="producto">
	          <tr>
	            <th scope="row"></th>
	            <td>${pedido.id}</td>
	            <td>${pedido.total}</td>
        					...
        					<div class="modal-content">
            					...
            					<form action="Update_pedido" method="POST">
								    <div class="modal-body">
	                    				...
	                    				<div class="mb-3">
								            <label for="dni_cliente" class="form-label"><b>Marca:</label>
								            <input type="text" class="form-control" id="dni_cliente" name="dni_cliente" value="${pedido.cliente.dni}">
								        </div>

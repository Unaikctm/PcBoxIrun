    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-3">
                <p class="mb-0">Correo electrónico: www.pcbox.com</p>
            </div>
            <div class="col-12 col-md-1">
            ...
            <div class="col-12 col-md-3">
                <p class="mb-0">Dirección: <br>Serapio Mujika, 26, Irún, GUIPUZCOA, 20302</p>
            </div>
            <div class="col-12 col-md-1">
            ...
            <div class="col-12 col-md-3">
                <p class="mb-0">Teléfono: <br>943 012 148</p>
            </div>
        </div>
    </div>
</footer>
